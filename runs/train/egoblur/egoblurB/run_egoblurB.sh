#!/bin/bash
# PII-1072 babysitter for the egoblurB fine-tune (copy of run_egoblurA.sh, NAME egoblurB) (port of training/run_arm.sh to detectron2).
...
#   GPU=<six idle> PORT=29518 setsid nohup bash run_egoblurB.sh > /dev/null 2>&1 &
NAME=${NAME:-egoblurB}
