"""WOR-146: copy of export_armY_onnx.py for armZ34 (CKPT/OUT changed; CFG stays the armY embedded 34G config, whose model block is byte-identical to scrfd_armZ34.py).
...
CKPT = Path("/data/esteban/pii/runs/train/wd_armZ34/epoch_20.pth")
OUT = Path("/data/esteban/pii/runs/train/armZ34_det34g.onnx")
