"""PII-1174: copy of the WOR-206 armAE34 exporter (md5 d6704cf1) for armAG34: only CKPT/OUT and
...
armAE34 inherits scrfd_armAA34.py, so CFG stays the armY embedded 34G config.
...
CKPT = Path("/data/esteban/pii/runs/train/wd_armAG34/epoch_20.pth")
OUT = Path("/data/esteban/pii/runs/train/armAG34_det34g.onnx")
...
def main() -> None:
    ...
    print("\n=== graph contract: armAG34 vs production det_10g.onnx ===")
