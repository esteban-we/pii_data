...
optimizer_config = dict(
    type='GradientCumulativeOptimizerHook', cumulative_iters=2, grad_clip=None)
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
...
work_dir = '/data/esteban/pii/runs/train/wd_armAJ34'
resume_from = None
workflow = [('train', 1)]
...
custom_hooks = [
    dict(
        type='EMAHook', momentum=0.0001, interval=1, warm_up=100, priority=49)
]
gpu_ids = range(0, 4)
