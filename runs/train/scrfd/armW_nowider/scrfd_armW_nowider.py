...
log_level = 'INFO'
load_from = '/data/esteban/pii/weights/SCRFD_10G_KPS_official.pth'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/mix_ds/train_W_nowider.txt',
...
_r = '/data/liangzhenghao/face_pii/raw_ds/'
_m = 'data/mix_ds/'
_assigner = dict(type='ATSSAssigner', topk=9, ignore_iof_thr=0.5)
work_dir = '/data/esteban/pii/train/wd_armW_nowider'
gpu_ids = range(0, 2)
