...
optimizer_config = dict(
    type='GradientCumulativeOptimizerHook', cumulative_iters=1, grad_clip=None)
lr_config = dict(
    policy='step',
    warmup='linear',
    warmup_iters=500,
...
log_level = 'INFO'
load_from = '/mnt/cachefs/esteban/pii/weights/SCRFD_34G_official.pth'
work_dir = '/mnt/cachefs/esteban/pii/runs/train/wd_armAH34_fluence'
resume_from = None
workflow = [('train', 1)]
...
data = dict(
    ...
    train=dict(
        ...
        ann_file='data/mix_ds/train_Z5.txt',
